...
.document_top_area .document_top_right .info_2line { border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px;}
.document_top_area .document_top_right .info_2line .info_item { width:24.5%; display: inline-block; }
...
.document_top_area .document_top_right .info_3line { border-bottom: 2px solid #777; margin-bottom:5px; padding-bottom: 10px; display: inline-block;  width:100%; }
...
.document_top_area .document_top_right .info_3line span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#aaa; margin-bottom: 5px; }
.document_top_area .document_top_right .info_3line span.value { display: inline-block; font-size: 1.25rem; font-weight: 700; width:100%; color:#222; margin-bottom: 10px; }
...
.document_info_area .info_2line { border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px;}
...
.document_info_area .info_3line { border-bottom: 2px solid #777; margin-bottom:5px; padding-bottom: 10px; display: inline-block;  width:100%; }
...
.document_info_area .info_3line span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#aaa; margin-bottom: 5px; }
.document_info_area .info_3line span.value { display: inline-block; font-size: 1.25rem; font-weight: 700; width:100%; color:#222; margin-bottom: 10px; }
...
.document_info2_area .info_2line { border-bottom: 1px solid #ccc; margin-bottom:5px; padding-bottom: 10px;}
...
.document_info2_area .info_3line { border-bottom: 2px solid #777; margin-bottom:5px; padding-bottom: 10px; display: inline-block;  width:100%; }
.document_info2_area .info_3line .info_item { width:100%; display: inline-block; }
.document_info2_area .info_3line span.item_name { display: inline-block; font-size: 1rem; font-weight: 300; width:100%; color:#aaa; margin-bottom: 5px; }
.document_info2_area .info_3line span.value { display: inline-block; font-size: 1.25rem; font-weight: 700; width:100%; color:#222; margin-bottom: 10px; }
</style>
	...
	<div id="kboard-snu-clothing-menber-document">
		<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
		    <div class="document_top_area">
		        ...
		        <div class="document_top_right">
		            <div class="info_1line">
		                <div class="info_item"><span class="title"><?php echo $content->title?></span><span>(<?php echo $content->option->{'Name_English'}?>, <?php echo $content->option->{'Name_Chinese'}?>)</span></div>
		            </div>
		            ...
		            <div class="info_3line">
		                <div class="info_item1"><span class="item_name">연락처</span><span class="value"><?php echo $content->option->{'Mobile_No'}?></span></div>
		                <div class="info_item2"><span class="item_name">이메일</span><span class="value"><?php echo $content->option->{'Email_On_Campus'}?>, <?php echo $content->option->{'Email_Out_of_Campus'}?></span></div>
		            </div>      
		        </div>
		    </div>
            <div class="document_info_area">
		            ...
		            <div class="info_3line">
		                <div class="info_item1"><span class="item_name">학적 변동</span><span class="value"><?php echo $content->option->{'Academic_Change'}?></span></div>
		                <div class="info_item1"><span class="item_name">등록 구분</span><span class="value"><?php echo $content->option->{'Registration_Category'}?></span></div>
		                <div class="info_item2"><span class="item_name">대학원(졸업연도)</span><span class="value"><?php echo $content->option->{'Graduate_School'}?></span></div>
		            </div>      
            </div>
            <div class="document_info2_area">
		            ...
		            <div class="info_3line">
		                <div class="info_item1"><span class="item_name">비고</span><span class="value"><?php echo $content->content?></span></div>
		            </div>      
            </div>
