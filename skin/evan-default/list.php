<div id="kboard-evan-default-list">
					...
					<td class="kboard-list-title">
						<a href="<?php echo $url->getDocumentURLWithUID($content->uid)?>">
							<div class="kboard-evan-default-cut-strings">
								<?php if($content->isNew()):?><span class="kboard-evan-default-new-notify">New</span><?php endif?>
	...
	<div class="kboard-search">
		<form id="kboard-search-form-<?php echo $board->id?>" method="get" action="<?php echo $url->toString()?>">
			...
			<button type="submit" class="kboard-evan-default-button-small"><?php echo __('Search', 'kboard')?></button>
		</form>
	</div>
	<!-- 검색폼 끝 -->
	...
	<div class="kboard-control">
		<a href="<?php echo $url->getContentEditor()?>" class="kboard-evan-default-button-small"><?php echo __('New', 'kboard')?></a>
	</div>
	<!-- 버튼 끝 -->
	<?php endif?>
